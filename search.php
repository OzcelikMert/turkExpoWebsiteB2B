...
<?php 
    ...
    include("./pages/search/functions/values.php");
    include("./pages/search/functions/get_page_count_buttons.php");
    include("./pages/search/functions/get_values.php");
?>
    <div class="super_container">
        <?php
        include("./sameparts/header.php");
        include("./sameparts/menu.php");
        include("./pages/search/search-index.php");
